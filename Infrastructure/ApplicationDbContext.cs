...
namespace Infrastructure
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=Ex09_Architecture_et_Conception;Trusted_Connection=True;", options => options.MigrationsAssembly("Infrastructure"));
            }            
        }
